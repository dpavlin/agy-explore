...
- `-v`, `--verbose`: Set progressive verbosity level:
  - `-v`: Detailed Generated Files list showing relative paths, formatted sizes, modification times, and full text content of markdown/text files.
  ...
  - `-vvv`: Bypasses default formatting to enable standard developer debugging telemetry to stderr.
